...
function solution(people, limit) {
    var answer = 0;
    people.sort((a, b) => a-b);
    //제일 큰 값과 제일 작은 값을 더해서 
    //limit 값 이하 이면 두 값을 모두 splice
    
    //limit 값 보다 크다면 제일 큰 값만 splice
    //이후 이것을 계쏙 반복.
...
//sort는 배열 안에 있는 내용을 자동으로 string으로 변환 후 유니코드로 정렬됩니다. 
//그래서 2자리수 이상의 수를 비교할때 callback 함수를 안해주면 제대로 정렬이 되지 않습니다.